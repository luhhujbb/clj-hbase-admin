...
public class HBaseClusterStatus {
  ...
  //}
    ...
    // ClusterStatus st = admin.getClusterStatus(); // co ClusterStatusExample-1-GetStatus Get the cluster st.
    //
    // System.out.println("Cluster Status:\n--------------");
    // System.out.println("HBase Version: " + st.getHBaseVersion());
    // System.out.println("Version: " + st.getVersion());
    // System.out.println("Cluster ID: " + st.getClusterId());
    // System.out.println("Master: " + st.getMaster());
    // System.out.println("No. Backup Masters: " +
    //   st.getBackupMastersSize());
    // System.out.println("Backup Masters: " + st.getBackupMasters());
    //
    // System.out.println("No. Live Servers: " + st.getServersSize());
    // System.out.println("Servers: " + st.getServers());
    // System.out.println("No. Dead Servers: " + st.getDeadServers());
    // System.out.println("Dead Servers: " + st.getDeadServerNames());
    // System.out.println("No. Regions: " + st.getRegionsCount());
    // System.out.println("Regions in Transition: " +
    //   st.getRegionsInTransition());
    // System.out.println("No. Requests: " + st.getRequestsCount());
    // System.out.println("Avg Load: " + st.getAverageLoad());
    // System.out.println("Balancer On: " + st.getBalancerOn());
    // System.out.println("Is Balancer On: " + st.isBalancerOn());
    // System.out.println("Master Coprocessors: " +
    //   Arrays.asList(st.getMasterCoprocessors()));
